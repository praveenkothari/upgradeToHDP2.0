...
###Directories created with node hostnames  

   mkdir -p p_output/hdp1.hortonworks.hdp
   mkdir -p p_output/hdp2.hortonworks.hdp
   mkdir -p p_output/hdp3.hortonworks.hdp
