...
export YARN_RESOURCEMANAGER_OPTS="${YARN_OPTS} -Xms2g -Xmx2g -XX:MaxNewSize=512m -XX:NewSize=512m -Dhadoop.mapreduce.jobsummary.logger=INFO,JSA -verbose:gc -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+HeapDumpOnOutOfMemoryError -XX:+UseConcMarkSweepGC -XX:+UseParNewGC -XX:CMSInitiatingOccupancyFraction=85 -XX:+UseCMSCompactAtFullCollection -Xloggc:$YARN_LOG_DIR/yarn-gc-rm.log -XX:ErrorFile=$YARN_LOG_DIR/yarn-rm-hs_err_pid.log"

export YARN_NODEMANAGER_OPTS="${YARN_OPTS} -Xmx1536m -Xms1536m"
